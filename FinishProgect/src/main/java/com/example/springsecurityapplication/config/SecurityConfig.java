...
//                .antMatchers("/user").hasAnyRole("USER")
                ...
                .antMatchers( "/login","/auth/about","/auth/index1", "/auth/login", "/error", "/auth/registration", "/product", "/product/info/{id}", "/img/**","/img/**", "/product/search").permitAll()
...
//                .anyRequest().authenticated()
                ...
                .and()
                .formLogin().loginPage("/auth/index1")
                ...
                .logout().logoutUrl("/logout").logoutSuccessUrl("/auth/index1");
    }
